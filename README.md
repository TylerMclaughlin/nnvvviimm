...
This is a fork of thgrund's tidal.nvim.  While it works great, i was having issues with the configuration file so i made a fork to just edit the source code and re-install separately.
...
Was having issues with the code block here.
